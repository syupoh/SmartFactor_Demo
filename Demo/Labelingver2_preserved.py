...
##########################
    ...
    def buttdir(self):               
        ...
        if os.path.exists('/media/'):
            self.FilePath = "/home/syup/Dropbox/"
        ...
        # if os.path.exists('/media'):
            # self.FilePath = '/media/syup/Toshiba_3TB/SmartFactory/181004_BusinessTrip/collection_out_sewing/Seam_work_half2/1/'
        # else:
            # self.FilePath = 'F:/Dropbox/_ISPL/SmartFactory/Seam_work_half2/3/'
            # self.FilePath = 'F:/Dropbox/_ISPL/SmartFactory/Seam_work_full/sangyup_half2/1/'
            # self.FilePath = 'C:/Users/JOHN/Dropbox/_ISPL/SmartFactory/Seam_work_full/sangyup_half2/1/'
    ...
    def buttlabel(self):
        ...
        if not self.imgdirlist == '':
            if self.dirn+1 == len(self.imgdirlist):
                ...
                print('File loaded : {0}/{1} files'.format(self.dirn,len(self.imgdirlist) ))
                print(' '+self.imgdir)
    ...
    def OnMouseDrag(self, event):
        ...
        if self.framet==0:
            self.rectpo3 = self.C3.create_rectangle(x1,y1,x2,y2, fill="black", outline="black")
        elif self.framet==7:
            self.rectpo3 = self.C3.create_rectangle(x1,y1,x2,y2, fill="white", outline="white")
        else:
            self.rectpo3 = self.C3.create_rectangle(x1,y1,x2,y2, fill="red", outline="red")
