...
class App:
    def __init__(self, window12, window_title):
        ...
        self.main_lbl1 = tkinter.Label(self.window, image=self.main_img1_tk)
        ...
        self.main_lbl2 = tkinter.Label(self.window, image=self.main_img2_tk)
        ...
        self.main_lbl3 = tkinter.Label(self.window, image=self.main_img3_tk)
